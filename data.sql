...
INSERT INTO `cart_cartinfo` VALUES (9,1,30,1),(10,1,18,1),(11,1,45,1),(12,1,33,1),(13,1,29,1);
...
CREATE TABLE `order_orderdtailinfo` (
  ...
  PRIMARY KEY (`id`),
  KEY `order_orde_goods_id_6ed79015a51048ee_fk_goods_goodsinfo_id` (`goods_id`),
  KEY `order_orderdtailinfo_69dfcb07` (`order_id`),
  CONSTRAINT `order_ord_order_id_4c9a9d89c03991c8_fk_order_orderinfo_oid` FOREIGN KEY (`order_id`) REFERENCES `order_orderinfo` (`oid`),
  CONSTRAINT `order_orde_goods_id_6ed79015a51048ee_fk_goods_goodsinfo_id` FOREIGN KEY (`goods_id`) REFERENCES `goods_goodsinfo` (`id`)
...
INSERT INTO `order_orderdtailinfo` VALUES (1,18.50,18.50,1,4,'201710281920071'),(2,8.80,26.40,3,1,'201710281920251'),(3,18.50,37.00,2,4,'201710281922161'),(4,10.00,10.00,1,3,'201710281922161'),(5,8.80,17.60,2,2,'201710281922161'),(6,8.80,8.80,1,1,'201710281922161'),(7,8.80,8.80,1,28,'201710281935331'),(8,18.50,92.50,5,10,'201710282104371');
...
INSERT INTO `order_orderinfo` VALUES ('201710281920071','2017-10-28 11:20:07.980884',1,28.50,'天津 西青区 天津理工大学 （何谦 收） 1374567891',1),('201710281920251','2017-10-28 11:20:25.922830',1,36.40,'天津 西青区 天津理工大学 （何谦 收） 1374567891',1),('201710281922161','2017-10-28 11:22:16.441055',1,83.40,'天津 西青区 天津理工大学 （何谦 收） 1374567891',1),('201710281935331','2017-10-28 11:35:33.576674',1,18.80,'天津 西青区 天津理工大学 （何谦 收） 1374567891',1),('201710282104371','2017-10-28 13:04:37.967904',1,92.50,'天津 西青区 天津理工大学 （何谦 收） 1374567891',1);
...
-- Dump completed on 2017-11-02  8:49:24
